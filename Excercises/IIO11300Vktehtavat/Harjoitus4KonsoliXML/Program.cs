...
namespace Harjoitus4KonsoliXML
{
    // KOKEESSA XML:N LUKEMISTA, MUISTA TÄMÄ
    class Program
    {
        static void ReadWorkersFromXML(string filu)
        {
            //Tutkitaan löytyykö tiedostoa ennen kuin aletaan lukea sitä
            if(System.IO.File.Exists(filu))
            {
                ...
                {
                    xn = xnl.Item(i);
                    // näytetään noodin sisältö kokonaisuudessaan
